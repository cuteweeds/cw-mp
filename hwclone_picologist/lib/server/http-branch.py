...
class wifi:
    ...
    """
    def webpage(self, page, temperature, pressure, water1, water2, light, date, hour):
        page = str(page)
    ...
    def serve(self, connection, page, temperature, pressure, water1, water2, light, date, hour):
        global led
    ...
    if test_loop==0: 
        ...
        while True:
            try:
                ...
                serve(connection,'/lib/www/interactiveindex.html',1,2,3,4,5,6,7)
